...
<body>
  ...
  <script>
    ...
    slider.oninput = function() {
      ...
      output.innerHTML = "Delay: " + (200-value) + "ms";
    ...
    colorPicker.on('input:change', function(value) {
      var xhttp = new XMLHttpRequest();
      xhttp.open("GET", "/set_color?value=" + value.hexString.substring(1) , true);
      xhttp.send();
    });
